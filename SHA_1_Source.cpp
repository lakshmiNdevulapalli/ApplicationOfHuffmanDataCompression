...
/*
* SHA1PadMessage
* Description: According to SHA1 standard, the message must be padded to an even
* 512 bits. The first paddign bit must be a '1'. the last 64 bits represent the
* length of the original message. All bits in between should be 0.This function will pad the message
* according to those rules by filling the Message_Block array accordingly.
